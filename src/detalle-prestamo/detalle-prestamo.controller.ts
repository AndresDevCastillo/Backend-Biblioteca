...
export class DetallePrestamoController {
  ...
  createDetallePrestamo(@Body() createDetallePrestamoDto: CreateDetallePrestamoDto) {
    return this.detallePrestamoService.createDetallePrestamo(createDetallePrestamoDto);
  }
  ...
  getDetallePrestamo(@Param('id', ParseIntPipe) id: number): Promise <DetallePrestamo> {
    return this.detallePrestamoService.getDetallePrestamo(id);
  }

  @Put('/actualizar/:id')
  updateDetallePrestamo(@Param('id', ParseIntPipe) id: number, @Body() updateDetallePrestamoDto: UpdateDetallePrestamoDto) {
    return this.detallePrestamoService.updateDetallePrestamo(id, updateDetallePrestamoDto);
  }
